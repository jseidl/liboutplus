...
docdir = $(datarootdir)/doc/liboutplus
...
liboutplus_BUILDDIR = $(CURDIR)/build
liboutplus_SRCS_FILTER = $(wildcard ${dir}/*.c)
liboutplus_SRCS = $(foreach dir, ${srcdir}, ${libpe_SRCS_FILTER})
liboutplus_OBJS = $(addprefix ${libpe_BUILDDIR}/, $(addsuffix .o, $(basename ${libpe_SRCS})))

####### Build rules

.PHONY : liboutplus install strip-binaries install-strip uninstall clean

all: liboutplus

liboutplus: CPPFLAGS += -D_GNU_SOURCE
liboutplus: $(libpe_OBJS)
